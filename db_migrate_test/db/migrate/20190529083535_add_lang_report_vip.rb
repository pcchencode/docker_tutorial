class AddLangReportVip < ActiveRecord::Migration[5.2]
  def up
    execute <<-SQL
      CREATE TABLE `tb_rate_anchor` (
      ...
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='主播评级表 --created by xiaoyi.shen;';
    SQL
  end
  
  def down
    drop_table :tb_rate_anchor
  end
end
